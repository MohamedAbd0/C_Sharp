...
namespace com.calitha.goldparser
{
    ...
    enum SymbolConstants : int
    {
        ...
        SYMBOL_CLASSMINUSSTMT  = 48, // <class-stmt>
        SYMBOL_CONST           = 49, // <const>
        SYMBOL_EXPR            = 50, // <expr>
        SYMBOL_FACTOR          = 51, // <factor>
        SYMBOL_FORMINUSSTMT    = 52, // <for-stmt>
        SYMBOL_FUNMINUSSTMT    = 53, // <fun-stmt>
        SYMBOL_IFMINUSSTMT     = 54, // <if-stmt>
        SYMBOL_INC             = 55, // <inc>
        SYMBOL_LITERAL         = 56, // <literal>
        SYMBOL_LOGICMINUSEXPR  = 57, // <logic-expr>
        SYMBOL_OP              = 58, // <op>
        SYMBOL_PARM            = 59, // <parm>
        SYMBOL_PROG            = 60, // <prog>
        SYMBOL_STMT            = 61, // <stmt>
        SYMBOL_STMTMINUSLIST   = 62, // <stmt-list>
        SYMBOL_SWITCHMINUSCASE = 63, // <switch-case>
        SYMBOL_TERM            = 64, // <term>
        SYMBOL_TYPES           = 65, // <types>
        SYMBOL_VARIABLE        = 66, // <variable>
        SYMBOL_WHILEMINUSSTMT  = 67  // <while-stmt>
    };
    ...
    enum RuleConstants : int
    {
        ...
        RULE_IFSTMT_IF_LPAREN_RPAREN_THEN                                           = 28, // <if-stmt> ::= if '(' <logic-expr> ')' then <stmt-list>
        RULE_IFSTMT_IF_LPAREN_RPAREN_THEN_ELSE                                      = 29, // <if-stmt> ::= if '(' <logic-expr> ')' then <stmt-list> else <stmt-list>
        ...
        RULE_CLASSSTMT_CLASS_IDENTIFIER_LPAREN_RPAREN_LBRACE_RBRACE                 = 52, // <class-stmt> ::= <acces-mod> class Identifier '(' ')' '{' <variable> <const> <fun-stmt> '}'
        RULE_VARIABLE_IDENTIFIER_SEMI                                               = 53, // <variable> ::= <types> Identifier ';'
        RULE_CONST_PUBLIC_IDENTIFIER_LPAREN_RPAREN_LBRACE_RBRACE                    = 54  // <const> ::= public Identifier '(' <variable> ')' '{' <assign> '}'
    };
    ...
    public class MyParser
    {
        ...
        public Object CreateObjectFromNonterminal(NonterminalToken token)
        {
            switch (token.Rule.Id)
            {
                ...
                case (int)RuleConstants.RULE_IFSTMT_IF_LPAREN_RPAREN_THEN :
                //<if-stmt> ::= if '(' <logic-expr> ')' then <stmt-list>
                //todo: Create a new object using the stored tokens.
                return null;

                case (int)RuleConstants.RULE_IFSTMT_IF_LPAREN_RPAREN_THEN_ELSE :
